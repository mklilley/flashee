  ...
  return (
    <Modal close={close} color="purple">
      <form className="edit-flashcard" onSubmit={saveCard}>
        ...
        <br />
        <br />
        <input placeholder="Answer" value={answer} onChange={handleAnswerChange} required></input>
      ...
      {showMathAnswer && (
        <MathLive latex={stripKatexDollars(answer)} saveMath={setAnswer} close={toggleMathAnswer} />
      )}
      {showMathQuestion && (
        <MathLive
